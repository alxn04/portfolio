...
Здесь я собираю примеры некоторых своих работ и решений тестовых заданий на позиции "Продуктовый аналитик"/"Аналитик данных" от разных компаний.
...
* [EDA Т-Банк сервис Город](https://github.com/alxn04/portfolio/tree/main/EDA%20%D0%A2-%D0%91%D0%B0%D0%BD%D0%BA%20%D0%93%D0%BE%D1%80%D0%BE%D0%B4)

Разведочный анализ данных сервиса Город вместе с аналитической запиской в виде презентации, в которой представлены результаты анализа и выдвинуты гипотезы по развитию сервиса.
